<template>  <div
  ...
  >
    ...
    <!-- left side -->
    <div class="z-10 flex w-full flex-col items-start justify-center lg:w-auto">
      <!-- header texts -->
      <div id="header-texts" class="text-left opacity-0 h-screen flex flex-col justify-center">
        <h2 class="text-3xl text-gold md:text-6xl mb-2">Welcome to</h2>
        <h2 class="text-5xl font-semibold md:text-8xl mb-4">Staten Island</h2>
        <h2 class="text-5xl font-semibold md:text-8xl mb-4">Technical</h2>
        <h2 class="text-5xl font-semibold md:text-8xl mb-4">High School</h2>
        <div class="flex flex-row items-center">
          <img src="../assets/icons/location-pin.svg" alt="Location pin icon" />
          <p class="text-md p-4 lg:text-lg">485 Clawson St, Staten Island, NY 10306</p>
        </div>
        <!-- stats container -->
