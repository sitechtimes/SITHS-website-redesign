...
export const summerHomework = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: 'Link to 9th Grade Summer Homework (URLs only)',
      type: 'url',
    }),
    defineField({
      name: 'tenth',
      title: '10th Grade Summer Homework',
      description: 'Link to 10th Grade Summer Homework (URLs only)',
      type: 'url',
    }),
    defineField({
      name: 'eleventh',
      title: '11th Grade Summer Homework',
      description: 'Link to 11th Grade Summer Homework (URLs only)',
      type: 'url',
    }),
    defineField({
      name: 'twelfth',
      title: '12th Grade Summer Homework',
      description: 'Link to 12th Grade Summer Homework (URLs only)',
      type: 'url',
    }),
  ],
