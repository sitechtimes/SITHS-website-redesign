...
const navLinks = [
  ...
  {
    category: 'Academics',
    categoryValue: 'academics',
    links: [{ name: 'AP Courses', path: '/ap-courses', directLink: false }]
  },
  {
  ...
  },
  {
    ...
    links: [{ name: 'Directory', path: '/', directLink: false }]
  }
]
...
function addDirectLinks(directLinks) {
  ...
  const mapCategories = {
    ...
    Academics: directLinks.academics || [],
