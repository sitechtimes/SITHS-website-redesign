<template>
  <div class="mx-4 h-fit lg:mx-10">
    <h1 class="mb-8 text-4xl font-kumbh font-semibold text-center p-6">
      Faculty and Staff
    </h1>
    <div v-for="category in categories" :key="category.value" class="lg:mx-8">
      ...
      <!-- staff component -->
      <div class="my-12 flex w-full flex-row flex-wrap justify-between gap-4 lg:grid lg:grid-cols-2 lg:mx-4 lg:w-auto lg:gap-6">
