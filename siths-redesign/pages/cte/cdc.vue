<template>
    ...
    <div class="flex flex-col md:flex-row justify-center items-start px-4">
        <SubpageMenu :pages="cteLinks" :active="'CDC in the News'" class="w-full md:w-auto mb-4 md:mb-0 md:mr-8"/>
        <div class="flex items-center justify-center flex-col w-full md:w-5/6">
            <h2 class="text-xl md:text-2xl mb-4 md:mb-8">CDC in the News</h2>
